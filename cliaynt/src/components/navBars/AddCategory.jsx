...
function AddCategory() {
    ...
    const handelSubmit = async (c) => {
        ...
        try {
            const result = await api.post('/admin/add-category', categorys)
        ...
        <div className="flex justify-center items-center p-6 bg-gray-50 mt-6">
            ...
            <form onSubmit={handelSubmit}>
                <div className="w-96 bg-white rounded-xl shadow-md p-6 border border-gray-100">
                    <h2 className="text-xl font-bold text-center mb-6 text-indigo-800">Add Category</h2>

                    <div className="space-y-5">
                        <div className="group">
                            <input
                                onChange={e => setCategorys({ ...categorys, category: e.target.value })}
